      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Remotely Maintain and access our knowledge base, From Anywhere, Anytime.`,
              description: `Integrate seamlessly with your favorite CRM tools like Freshworks, Salesforce, ServiceNow, Freshservice, Zendesk, and Talkdesk. Manage your data with efficiency and ensure your workflow stays uninterrupted across all platforms.`,
            }}
          />
