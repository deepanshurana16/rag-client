          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <span className="font-medium text-black dark:text-white">
                <span className="mb-4 mr-4 inline-flex rounded-full bg-meta px-4.5 py-1 text-metatitle text-white ">
                  New
                </span>{" "}
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>Get responses that align with your uploaded data for accuracy and relevance.</p>
                </div>
              </div>
            </motion.div>
          </div>
