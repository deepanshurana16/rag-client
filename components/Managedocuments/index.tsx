...
import { Trash2, RefreshCw, FileIcon, X, Upload, Globe, CheckCircle, AlertCircle } from "lucide-react"
            ...
            <div className="w-full md:w-1/2">
              <div className="flex flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800 h-[520px]">
                <div className="flex items-center justify-between border-b border-gray-200 p-4 dark:border-gray-700">
                  <h2 className="text-xl font-semibold text-gray-800 dark:text-white">➕ Add New Documents</h2>
                </div>

                {/* Added extra padding at the top to move content down */}
                <div className="flex flex-grow flex-col p-4 overflow-auto mt-2">
                  {/* File Upload Section */}
                  <div
                    {...getRootProps()}
                ...
                <div className="flex flex-grow flex-col p-4 pt-4 overflow-hidden">
                  {loading ? (
                    ...
                    <div className="flex flex-grow flex-col items-center justify-center py-8 text-center">
                      ...
                      <h3 className="text-lg font-medium text-gray-800 dark:text-white">No files uploaded❗️</h3>
        ...
        {fileToDelete && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
              <h3 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Delete file</h3>
