          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Discover Knowledge Effortlessly with Our RAG AI Solution
              </h2>
              <p>
                Access the power of intelligent knowledge base search and real-time
                answers. Upload your documents, ask questions, and get precise
                insights instantly. Revolutionize the way you interact with
                information.
              </p>
            </motion.div>
            <motion.div
